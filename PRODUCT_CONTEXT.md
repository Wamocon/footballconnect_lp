# PRODUCT CONTEXT
## Source repository: Wamocon/footballconnect
## Product name (derived from repo): footballconnect
...
Diese Allgemeinen Geschaeftsbedingungen gelten fuer die Nutzung der Webanwendung FootballConnect, betrieben von der WAMOCON GmbH, Mergenthalerallee 79 - 81, 65760 Eschborn.

## Paragraph 2 Leistungsbeschreibung

FootballConnect ist eine Online-Plattform zur Vernetzung von Amateurfussballspielern, Trainern und Vereinen. Der Dienst ermoeglicht Spielern die Vereinssuche und Bewerbung, Trainern die Mannschaftsverwaltung und Vereinen die Mitglieder- und Bewerbungsverwaltung. Der kostenlose Plan umfasst Basisfunktionen mit Einschraenkungen, der Pro-Plan bietet erweiterte Funktionen.

## Paragraph 3 Nutzungsbedingungen

Die Nutzung des kostenlosen Dienstes erfordert eine Registrierung mit einer E-Mail-Adresse. Die Plattforminhalte (Vereinslisten, Bewerbungstools, Mannschaftsverwaltung) dienen als organisatorische Hilfsmittel und ersetzen keine vertraglichen Verpflichtungen zwischen Nutzern und Vereinen.

## Paragraph 4 Nutzungsrechte

Der Anbieter raeumt dem Nutzer ein einfaches, nicht uebertragbares Recht zur Nutzung der Plattform fuer die Vertragsdauer ein. Der Nutzer darf die Plattform nur fuer persoenliche oder organisatorische Zwecke im Zusammenhang mit Amateurfussball nutzen.

## Paragraph 5 Pflichten des Nutzers

Der Nutzer ist verpflichtet, seine Zugangsdaten geheim zu halten und vor dem Zugriff Dritter zu schuetzen. Der Nutzer stellt sicher, dass die Nutzung der Plattform im Einklang mit geltendem Recht erfolgt.

## Paragraph 6 Haftungsausschluss

Die WAMOCON GmbH uebernimmt keine Haftung fuer die Richtigkeit nutzergenerierter Inhalte, Vereinsinformationen oder Bewerbungsergebnisse. Alle Interaktionen zwischen Nutzern und Vereinen erfolgen in eigener Verantwortung. Der Anbieter haftet unbeschraenkt fuer Schaeden aus der Verletzung des Lebens, des Koerpers oder der Gesundheit sowie bei Vorsatz und grober Fahrlaessigkeit.

## Paragraph 7 Datenschutz

Die Verarbeitung personenbezogener Daten erfolgt gemaess unserer Datenschutzerklaerung und den Bestimmungen der DSGVO.

## Paragraph 8 Vertragslaufzeit und Kuendigung

Der Vertrag wird auf unbestimmte Zeit geschlossen und kann von beiden Parteien mit einer Frist von einem Monat zum Monatsende gekuendigt werden. Das Recht zur ausserordentlichen Kuendigung aus wichtigem Grund bleibt unberuehrt.

## Paragraph 9 Anwendbares Recht
...
Diese Datenschutzerklaerung gilt fuer die Website und Webanwendung FootballConnect (footballconnect.vercel.app). Wir verarbeiten personenbezogene Daten unserer Nutzer grundsaetzlich nur, soweit dies zur Bereitstellung einer funktionsfaehigen Plattform sowie unserer Inhalte und Leistungen erforderlich ist.
...
Die Website und Webanwendung werden ueber Vercel (Vercel Inc., San Francisco, USA) gehostet. Dabei verarbeitet Vercel technisch notwendige Verbindungsdaten (IP-Adresse, Zeitstempel, Browserinformationen). Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO.

### Supabase Inc.

Fuer Datenbank, Authentifizierung und Teile der Backend-Infrastruktur nutzen wir Supabase. Verarbeitet werden Authentifizierungsdaten, Session-Informationen und Projektdaten. Rechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO.

## 5. Erhebung personenbezogener Daten

Bei der Registrierung erheben wir: Name, E-Mail-Adresse und Passwort. Diese Daten sind zur Vertragserfullung erforderlich (Art. 6 Abs. 1 lit. b DSGVO).
...
Die Plattform verwendet technisch notwendige Cookies fuer Session-Management und Authentifizierung. Tracking-Cookies werden nicht verwendet. Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO.
...
Wir setzen technische und organisatorische Sicherheitsmassnahmen nach dem Stand der Technik ein, um Ihre Daten gegen zufaellige oder vorsaetzliche Manipulation, Verlust, Zerstoerung oder den Zugriff unberechtigter Personen zu schuetzen.

## 9. Aenderung der Datenschutzerklaerung

Wir behalten uns vor, diese Datenschutzerklaerung anzupassen, um sie an geaenderte Rechtslagen oder bei Aenderungen der Plattform anzupassen.
...
FootballConnect ist eine webbasierte Software-as-a-Service-Plattform fuer die digitale Verwaltung und Vernetzung im Amateurfussball. Die Plattform ermoeglicht Spielern die Vereinssuche und Bewerbung, Vereinen die Mitgliederverwaltung und Trainern die Teamorganisation. Das Angebot richtet sich an Fussballvereine, Trainer und Spieler im Amateurbereich.
...
This Privacy Policy applies to the website and web application FootballConnect (footballconnect.vercel.app). We process personal data of our users only insofar as this is necessary to provide a functional platform and our content and services.
...
The website and web application are hosted via Vercel (Vercel Inc., San Francisco, USA). Vercel processes technically necessary connection data (IP address, timestamp, browser information). Legal basis: Art. 6(1)(f) GDPR.

### Supabase Inc.

We use Supabase for database, authentication, and parts of the backend infrastructure. Authentication data, session information, and project data are processed. Legal basis: Art. 6(1)(b) GDPR.
...
The platform uses technically necessary cookies for session management and authentication. No tracking cookies are used. Legal basis: Art. 6(1)(f) GDPR.
...
These Terms and Conditions apply to the use of the web application FootballConnect, operated by WAMOCON GmbH, Mergenthalerallee 79 - 81, 65760 Eschborn.
...
Using the free service requires registration with an email address. The platform content (club listings, application tools, team management) serves as organisational aids and does not replace any contractual obligations between users and clubs.
...
The user shall keep access credentials confidential and protect them from third-party access. The user shall ensure that use of the platform complies with applicable law.

## Section 6 Disclaimer

WAMOCON GmbH assumes no liability for the accuracy of user-generated content, club information, or application outcomes. All interactions between users and clubs are carried out at their own responsibility. The provider is fully liable for damages arising from injury to life, body, or health, as well as for intent and gross negligence.

## Section 7 Data Protection

The processing of personal data is governed by our Privacy Policy and the provisions of the GDPR.

## Section 8 Contract Duration and Termination

The contract is concluded for an indefinite period and may be terminated by either party with one month's notice to the end of a calendar month. The right to extraordinary termination for good cause remains unaffected.

## Section 9 Applicable Law

The law of the Federal Republic of Germany applies. The place of jurisdiction is Eschborn.

## package.json
{
  "name": "footballconnect",
  "version": "0.1.0",
  "private": true,
  "scripts": {
